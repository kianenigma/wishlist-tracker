...
# Tracker repo
tracker_repo = g.get_repo("kianenigma/wishlist-tracker")

# Markdown tables for each category
md_tables = {
    'Developer': "| Feature Request | Summary | Votes | Status |\n| --- | --- | --- | --- |\n",
    'User': "| Feature Request | Summary | Votes | Status |\n| --- | --- | --- | --- |\n"
}
...
for category, (repo_name, issue_number) in issues.items():
    ...
    for (url, _, _, _), count in sorted_wishes:
        ...
        md_tables[category] += f"| {url} | {summary} | {count} | {status} |\n"
    print(md_tables[category])
